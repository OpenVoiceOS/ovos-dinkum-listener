...
class TestCyclicAudioBuffer(unittest.TestCase):
    ...
    def test_init_default(self):
        ...
        buf = self.CyclicAudioBuffer(duration=0.1, sample_rate=16000, sample_width=2)
    ...
    def test_init_with_initial_data_shorter_than_buffer(self):
        ...
        data = b"\x01" * 100
        buf = self.CyclicAudioBuffer(
            duration=1.0, sample_rate=16000, sample_width=2, initial_data=data
        )
    ...
    def test_init_with_initial_data_longer_than_buffer(self):
        ...
        buf = self.CyclicAudioBuffer(
            duration=0.1, sample_rate=16000, sample_width=2, initial_data=data
        )
    ...
    def test_append_within_capacity(self):
        ...
        buf = self.CyclicAudioBuffer(duration=1.0, sample_rate=16000, sample_width=2)
        chunk = b"\xff" * 100
        buf.append(chunk)
        result = buf.get()
    ...
    def test_size_attribute(self):
        ...
        buf = self.CyclicAudioBuffer(duration=0.5, sample_rate=16000, sample_width=2)
...
class TestHotwordState(unittest.TestCase):
    ...
    def test_hotword_state(self):
        ...
        for state in (
            HotwordState.LISTEN,
            HotwordState.HOTWORD,
            HotwordState.RECORDING,
            HotwordState.WAKEUP,
        ):
